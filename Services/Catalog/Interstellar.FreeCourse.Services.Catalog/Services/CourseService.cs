...
namespace Interstellar.FreeCourse.Services.Catalog.Services
{
    public class CourseService : ICourseService
    {
        ...
        public async Task<Response<CourseDto>> CreateAsync(CourseCreateDto courseCreateDto)
        {
            ...
            {
                return Response<CourseDto>.Fail("Kurs Eklerken hata oluştu. Msj: " + ex, 404);
            }
        ...
        {
            var updateCourse = _mapper.Map<Course>(courseUpdateDto);//courseUpdateDto'yu Course nesnesine dönüştürdük.
            ...
            return Response<NoContent>.Success(204);//bodysi olmayan bir durum kodu donecek.
        }
